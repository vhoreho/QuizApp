...
import { UpdateQuestionDto } from '../../quiz-system/questions/dto/update-question.dto';
...
export class TeacherController {
  ...
  getQuizResults(@Param('id') id: string, @Query('includePractice') includePractice?: boolean) {
    return this.resultsService.findByQuizId(+id, includePractice);
  }

  @Get('quizzes/:id/statistics')
  getQuizStatistics(@Param('id') id: string, @Query('includePractice') includePractice?: boolean) {
