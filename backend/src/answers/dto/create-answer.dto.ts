import { IsNotEmpty, IsNumber, IsString, IsEnum, IsOptional, IsArray, IsObject, ValidateIf } from 'class-validator';
...
export class CreateAnswerDto {
  ...
  @ValidateIf(o => o.questionType === QuestionType.SINGLE_CHOICE || o.questionType === QuestionType.TRUE_FALSE)
  @IsString()
