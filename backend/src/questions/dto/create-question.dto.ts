...
export class CreateQuestionDto {
  ...
  @IsString({ message: 'correctAnswer must be a string for SINGLE_CHOICE and TRUE_FALSE questions' })
  ...
  @IsNotEmpty({ message: 'correctAnswers array is required for MULTIPLE_CHOICE questions and cannot be empty' })
